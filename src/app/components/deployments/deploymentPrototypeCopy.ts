...
export const deploymentCopy = {
  ...
  fleetRollout: {
    ...
    navLabel: "Fleet rollouts",
    basePath: "/fleetrollout",
    pageSubtitle:
      "Fleet-level rollout status — whether change started in this console, Git, Argo CD, or automation.",
    sourceColumn: "Source",
    sourceFilterAll: "All",
    sourceFilterConsole: "Console",
    sourceFilterGit: "Git",
    sourceFilterArgocd: "Argo CD",
    sourceFilterAap: "AAP",
    sourceFilterAllTitle:
      "All run channels: console, Git, Argo CD, and Ansible Automation Platform.",
    sourceFilterConsoleTitle:
      "Started from this console (wizard) — monitoring and execution layer.",
    sourceFilterGitTitle:
      "Reconciled from Git (merge/PR) — change authored outside the console.",
    sourceFilterArgocdTitle:
      "Driven by Argo CD Application sync — not started in this console.",
    sourceFilterAapTitle:
      "Driven by Ansible Automation Platform job — not started in this console.",
    connectedSystemsTitle: "Connected systems (demo)",
    connectedSystemsHint:
      "Illustrative fleet signals — wire Argo CD, AAP, and Git separately in production.",
  },

  fleetRolloutDetail: {
    backToList: "Back to fleet rollout",
    startedBy: "Started by",
    openInExternal: (system: string) => `Open in ${system}`,
    freshnessJustNow: "Just now",
    refreshPrototypeToast:
      "Prototype — would pull the latest status from the connected system.",
    pauseRollout: "Pause rollout",
    cancelRemainingWaves: "Cancel remaining waves",
    ...
    completedSummaryTitle: "Rollout summary",
    changeTicket: "Change ticket",
    notFoundTitle: "Rollout not found",
    notFoundBody: "No prototype detail exists for this rollout id.",
  },
  ...
  wizard: {
    ...
    narrowSplitChevronAria:
      "More create paths — every area for Action first and Placement first",
  },
  ...
  steps: {
    ...
    hints: {
      plan:
        "Start with an action or with placement — suggested plans can recommend the other side before you continue.",
      action:
